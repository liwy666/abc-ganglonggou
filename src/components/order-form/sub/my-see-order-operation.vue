...
<script>
    export default {
        ...
        methods: {
            ...
            goPay() {
                try {
                    let success_url = encodeURIComponent(encodeURIComponent("https://" + window.location.host+'/#/home'));
                    let back_url = encodeURIComponent(encodeURIComponent(window.location.href));
